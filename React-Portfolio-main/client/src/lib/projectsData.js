export const projects = [
  {
    ...
    timeline: "2 Weeks",
    impact: "Provided real-time air quality forecasts and metrics to help users track local environmental conditions."
  },
  {
    id: 2,
    ...
    role: "Frontend Developer",
    timeline: "3 Weeks",
    impact: "Simplified personal finance management with clear budget visualization and tracking."
  },
  {
    id: 3,
    ...
    role: "Data Engineer",
    timeline: "1 Month",
    impact: "Delivered interactive sales analysis reports, optimizing store inventory decision-making."
  },
  {
    id: 4,
    ...
    timeline: "3 Weeks",
    impact: "Secured application access and improved task management workflow for productivity tracking."
  },
  {
    id: 5,
    ...
    role: "Frontend Developer",
    timeline: "1 Week",
    impact: "Demonstrated interactive logic implementation and responsive controls through simple HTML5 games."
  }
];
