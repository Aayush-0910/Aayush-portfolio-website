...
const skills = [
  ...
  { name: "Bootstrap", level: 85, category: "frontend", icon: "sass" },
  { name: "Tailwind CSS", level: 90, category: "frontend", icon: "css" },
  ...
  { name: "Vercel", level: 85, category: "tools", icon: "nextjs" },
];
