...
export const AboutSection = () => {
  ...
  const achievements = [
    { number: "2025", label: "Graduate", icon: <Briefcase className="h-5 w-5" />, suffix: "" },
    { number: "6", label: "Projects", icon: <Calendar className="h-5 w-5" />, suffix: "+" },
    { number: "7.08", label: "CGPA", icon: <Target className="h-5 w-5" />, suffix: "" },
    { number: "5", label: "Certifications", icon: <User className="h-5 w-5" />, suffix: "+" }
  ];

  const techStack = [
    { category: "Frontend", items: ["React.js", "JavaScript", "HTML", "CSS", "Bootstrap", "Tailwind CSS"] },
    { category: "Backend", items: ["Python", "FastAPIs", "MongoDB", "Firebase"] },
    { category: "Tools", items: ["Git", "Vercel", "VS Code", "Postman"] }
  ];
  ...
  const socialLinks = [
    { icon: <Github className="h-5 w-5" />, href: "https://github.com/Aayush-0910" },
    { icon: <Linkedin className="h-5 w-5" />, href: "https://www.linkedin.com/in/aayush-sinha-1a1a4b1a5/" },
    { icon: <Mail className="h-5 w-5" />, href: "mailto:sinhaaayush2001@gmail.com" }
  ];

  const tabContent = {
    personal: "I'm Aayush Sinha, a B.Tech CSE graduate from SRM Institute of Science & Technology (2025) with a CGPA of 7.08. Currently working as a Software Engineer at Aagati Serve, I'm passionate about building modern, responsive web applications using React.js and cutting-edge technologies.",
    professional: "With 6+ completed projects and hands-on experience in full-stack development, I specialize in React.js, JavaScript, Python, and cloud technologies. I focus on creating scalable, user-centric applications that deliver real value. Currently contributing to projects at Aagati Serve.",
    approach: "I believe in writing clean, maintainable code and following best practices in software engineering. My approach emphasizes performance optimization, user experience, and continuous learning. I'm committed to building solutions that are both elegant and functional."
  };
  ...
  const handleDownload = () => {
    ...
    link.href = '/Aayush-resume.pdf'; // Must be in public folder
    link.download = 'Aayush-resume.pdf';
              ...
              <div className="relative">
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-1 sm:mb-2">Aayush Sinha</h2>
                    <p className="text-primary text-base sm:text-lg font-semibold mb-3 sm:mb-4">React.js Specialist</p>
