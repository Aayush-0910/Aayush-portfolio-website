...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Linkedin size={18} />, href: "https://www.linkedin.com/in/aayush-sinha-1a1a4b1a5/", label: "LinkedIn" },
    { icon: <Github size={18} />, href: "https://github.com/Aayush-0910", label: "GitHub" },
    { icon: <Mail size={18} />, href: "mailto:sinhaaayush2001@gmail.com", label: "Email" },
  ];
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "sinhaaayush2001@gmail.com", href: "mailto:sinhaaayush2001@gmail.com" },
    { icon: <Phone size={16} />, text: "+91 8383860320", href: "tel:+918383860320" },
  ];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">AAYUSH</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Software Engineer specializing in React.js, creating modern web experiences with cutting-edge technologies.
              </p>
          ...
          >
            <div>
              <p>© {currentYear} Aayush Sinha. All rights reserved.</p>
            </div>
